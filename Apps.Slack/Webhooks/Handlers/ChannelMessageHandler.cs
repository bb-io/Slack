...
public class ChannelMessageHandler : BaseInvocable, IWebhookEventHandler
{
    const string SubscriptionEvent = "message.channels";

    public ChannelMessageHandler(InvocationContext invocationContext) : base(invocationContext) { }
